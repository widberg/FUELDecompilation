// This is actually a modified 1.8r header
// The closest bink headers I can find are from 1.8r and 1.8w
// A diff of the non-version number changes from r to w follows
// diff -r bink.1.8r.h bink.1.8w.h
// 288c272,273
...
#define BINKSUBVERSION 19
#define BINKVERSION "1.8s"
#define BINKDATE    "2007-01-25"
